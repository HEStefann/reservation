...
<?php endif; ?>
    ...
    <form method="POST" id="reservationForm" action="<?php echo e(route('user.reservation.store')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="mx-[26px] flex flex-grow flex-col">
            ...
            <input type="hidden" name="time" value="<?php echo e(old('time')); ?>" id="selectedTimeInput">
            <div class="mt-[14px] grid grid-cols-4 gap-[15px]" id="time-slots-container">
                ...
                ?>
                <?php for($i = $openingTime; $i < $closingTime; $i++): ?>
                    <?php for($j = 0; $j < 60; $j += 30): ?>
                        ...
                        <button type="button"
                            ...
                            data-time="<?php echo e($time); ?>"><?php echo e($time); ?></button>
                    <?php endfor; ?>
                <?php endfor; ?>
            </div>
            ...
            <div class="flex items-center gap-[8px]">
                ...
                <p id="numberOfPeople" class="text-[22px] text-[#343a40]"><?php echo e(old('number_of_people') ?? 2); ?></p>
                <input type="hidden" name="number_of_people" id="numberOfPeopleInput"
                    value="<?php echo e(old('number_of_people') ?? 2); ?>">
            ...
            <div class="flex mb-[18px]">
                ...
                <input type="hidden" name="floor_id" id="floorIdInput"
                    value="<?php echo e(old('floor_id') ?? $restaurant->floors[0]->id); ?>">
            </div>
            <style>
                .activeFloorButton {
            ...
            <div class="rounded-lg bg-[#fff5ec] px-[9px] py-[11px] relative" id="tablesContainer"
                ...
                <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex flex-col items-center justify-center gap-[1px] absolute"
                        style="left: <?php echo e($table->PositionLeft); ?>px; top: <?php echo e($table->PositionTop); ?>px;"
                        ...
                        <p class="rounded-[10px] bg-[#979797] text-[8px] font-semibold text-white flex items-center justify-center"
                            style="width: <?php echo e($table->Width); ?>px; height: <?php echo e($table->Height); ?>px;">
                            <?php echo e($table->TableDescription); ?>
            ...
            <div>
                <textarea id="note" name="note"
                    ...
                    value="<?php echo e(old('note')); ?>"></textarea>
            </div>
            <div class="flex items-center mt-[26px] gap-[4px]">
                <input type="checkbox" name="terms" id="terms"
                    class="w-3 h-3 border <?php echo e($errors->has('terms') ? 'border-red-500' : 'border-[#343a40]'); ?>">
                <label for="terms"
                    class="text-[10px] <?php echo e($errors->has('terms') ? 'text-red-500' : 'text-[#343a40]'); ?>">I agree
            ...
            <div class="flex flex-col gap-[10px] pb-[45px]">
                <div class="rounded-[10px] bg-[#fff5ec] pt-[21px] pl-[12px] pb-[17px] flex flex-col gap-[16px]">
                    <div class="flex gap-[16px]">
                        ...
                        <div class="flex flex-col gap-[4px]">
                            <p class="text-sm font-semibold  text-[#343a40]"><?php echo e($restaurant->title); ?></p>
                ...
                <div class="rounded-[10px] bg-[#fff5ec] flex gap-[19px] pt-[12px] pl-[13px] pb-[15px]">
                    ...
                    <div class="flex flex-col gap-[4px]">
                        ...
                        <p class="text-sm font-medium  text-[#343a40]">
                            <?php echo e(Auth::check() ? Auth::user()->phone : ''); ?>
...
<?php endif; ?>
    ...
    <script>
        ...
        function printTimes(date) {
            ...
            if (date == '') {
                openingTime = <?php echo e(substr($restaurant->workingHours->first()->opening_time, 0, 2)); ?>

                closingTime = <?php echo e(substr($restaurant->workingHours->first()->closing_time, 0, 2)); ?>
                ...
                date = `${year}-${month}-${day}`;
                const restaurantId = <?php echo e($restaurant->id); ?>;
...
<?php /**PATH /home/cakizy/Documents/github/reservation/resources/views/user/reservation.blade.php ENDPATH**/ ?>