<?php $__currentLoopData = $restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <a href="<?php echo e(route('user.restaurant', ['restaurant' => $restaurant->id])); ?>">
        <div class="rounded-bl-2xl rounded-t-2xl rounded-br-2xl bg-white mt-[28px] pb-[8px] shadow-2xl">
            <div class="relative">
                <?php if(Auth::check()): ?>
                    <button class="absolute right-[8px] top-[8px]" onclick="handleButtonClick(<?php echo e($restaurant->id); ?>)">
            ...
            <div class="flex justify-between ml-[25px] mr-[16px] items-center">
                <p class="text-[8px] font-light text-left text-[#6b686b]"><?php echo e($restaurant->average_price); ?>$ average
                    price
                </p>
                <div
...
<?php /**PATH C:\xampp\htdocs\reservation\resources\views/components/search-restaurant.blade.php ENDPATH**/ ?>