...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('user.restaurantspage')); ?>" method="GET" class="top-[46px] z-10">
    ...
    <div class="flex flex-col gap-[18px] items-center">
        ...
        <img class="rounded-[28px] snap-center" src="https://i.ibb.co/Pj8dWmq/Group-3118-1.png" alt="" onclick="window.location.href = '<?php echo e(route('user.restaurant', 3)); ?>'">
        <img class="rounded-[28px] snap-center" src="<?php echo e(asset('images\Group 3115.png')); ?>" alt="" onclick="window.location.href = '<?php echo e(route('user.restaurant', 1)); ?>'">
        <img class="rounded-[28px] snap-center" src="https://i.ibb.co/Pj8dWmq/Group-3118-1.png" alt="" onclick="window.location.href = '<?php echo e(route('user.restaurant', 3)); ?>'">
        <img class="rounded-[28px] snap-center" src="<?php echo e(asset('images\Group 3115.png')); ?>" alt="" onclick="window.location.href = '<?php echo e(route('user.restaurant', 1)); ?>'">
        <img class="rounded-[28px] snap-center" src="https://i.ibb.co/Pj8dWmq/Group-3118-1.png" alt="" onclick="window.location.href = '<?php echo e(route('user.restaurant', 3)); ?>'">
        <img class="rounded-[28px] snap-center" src="<?php echo e(asset('images\Group 3115.png')); ?>" alt="" onclick="window.location.href = '<?php echo e(route('user.restaurant', 1)); ?>'">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cakizy/Documents/github/reservation/resources/views/user/index.blade.php ENDPATH**/ ?>