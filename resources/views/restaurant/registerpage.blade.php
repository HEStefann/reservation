...
<body>
    ...
    <div class="flex items-center justify-center flex-col">
        <div class="rounded-[50px] bg-white items-center mx-[127px] my-[127px] px-[100px] py-[48px]">
            ...
            <form class="flex flex-col" method="POST" action="{{ route('restaurant.registerpage') }}">
                @csrf
                ...
                <div class="w-full justify-center" x-data="{ show: false }">
                    ...
                    <div class="relative">
                        <input name="password_confirmation" placeholder="Re-enter your password"
            ...
            <div class="mt-[44px] flex items-center">
                <svg width="169" height="1" viewBox="0 0 169 1" fill="none"
                    xmlns="http://www.w3.org/2000/svg" class="flex-grow" preserveAspectRatio="xMidYMid meet">
            ...
            <div>
                <p class="text-base text-center mt-[34px]">
                    ...
                    <a href="{{ route('restaurant.login') }}">
                        <span class="text-base text-center text-[#005fa4]">Log In</span>
                    </a>
                </p>
            </div>
        </div>
