...
<?php endif; ?>
            ...
            <div class="flex gap-[8px] py-[8px] flex-wrap">
                <?php $__currentLoopData = $restaurant->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <p class="flex-grow-0 flex-shrink-0 text-sm text-[#343a40]"><?php echo e($tag->name); ?></p>
                    </div>
        ...
        <div class="mt-[16px] flex flex-col gap-[10px]">
            <div class="flex">
                ...
                <div class="flex gap-3 items-center w-[50%]">
                    ...
                    <span
                        class="text-[10px] font-light text-[#343a40]"><?php echo e($restaurant->parking() ? 'Available' : 'Not Available'); ?></span>
                </div>
            </div>
            <div class="flex">
                <div class="flex gap-3 items-center w-[50%]">
                    ...
                    <span class="text-[10px] font-light text-[#343a40]">Open until
                        <?php echo e($restaurant->closingTime()); ?></span>
                </div>
                <div class="flex gap-3 w-[50%]">
                    ...
                    <span class="text-[10px] font-light text-[#343a40]"><?php echo e($restaurant->address); ?></span>
                </div>
            </div>
            ...
            <div class="pt-[16px]">
                <div class="flex">
                    <div class="flex gap-[6px] w-[50%]">
                        ...
                        <p class="text-[10px] text-white"><?php echo e($restaurant->website ?? 'www.DeKas.com'); ?></p>
                    </div>
                    <p class="text-[10px] text-white w-[50%]"><?php echo e($restaurant->email ?? 'info@restaurantdekas.nl'); ?>
                ...
                <div class="flex">
                    <div class="flex gap-[6px] w-[50%]">
                        ...
                        <p class="text-[10px] text-white"><?php echo e($restaurant->phone ?? '+31 20 462 4562'); ?></p>
                    </div>
                    <div class="flex gap-[15px] w-[50%]">
                        <div class="text-sm text-white w-[14px] h-[14px]">
                            <img class="w-full h-full" src="<?php echo e(asset('images/facebook.png')); ?>" alt="facebook" />
                        </div>
                        <div class="text-sm text-white w-[14px] h-[14px]">
                            <img class="w-full h-full" src="<?php echo e(asset('images/instagram.png')); ?>" alt="instagram" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            var currentIndex = 0;
            var images = <?php echo json_encode($restaurant->images()->pluck('image_url')); ?>;
            var imageCount = images.length;
            var $imageElement = $("#restaurant-image");

            function updateImage() {
                var imageUrl = images[currentIndex];
                var storageUrl = "<?php echo e(asset('storage/images/')); ?>/" + imageUrl;
...
<?php /**PATH /home/cakizy/Documents/github/reservation/resources/views/user/restaurant.blade.php ENDPATH**/ ?>