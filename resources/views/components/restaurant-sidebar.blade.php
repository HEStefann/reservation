<div class="min-h-screen min-w-[217px] flex flex-col">
    ...
    <div class="flex flex-col gap-[16px] mt-[11px] pl-[16px] w-full h-full" style="box-shadow: 0px 2px 1px -1px rgba(0,0,0,0.2), 0px 1px 1px 0 rgba(0,0,0,0.14), 0px 1px 3px 0 rgba(0,0,0,0.12);">
