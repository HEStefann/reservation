...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pt-[16px] px-[26px] pb-[64px]">
        <?php if($nearestRestaurants->count() > 0): ?>
            <div class="space-y-[28px]">
                <?php $__currentLoopData = $nearestRestaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cakizy/Documents/github/reservation/resources/views/user/nearest.blade.php ENDPATH**/ ?>