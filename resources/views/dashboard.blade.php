                ...
                <body>
                    ...
                    <body class="font-sans antialiased">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('reservations.store') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select id="restaurant_id" class="form-select" name="restaurant_id"
                                                    required>
                                                    @foreach ($restaurants as $restaurant)
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="deposit" type="number" min="0"
                                                            ...
                                                            name="deposit" value="{{ old('deposit') }}" required
                                                            autocomplete="deposit" autofocus>
                        ...
                        <!-- Add more form fields for other reservation details here -->
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        ...
                                        <p><b>Date:</b> <span id="modal-date"></span> <span id="modal-time"></span>
                                        </p>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary text-dark" id="editButton"
