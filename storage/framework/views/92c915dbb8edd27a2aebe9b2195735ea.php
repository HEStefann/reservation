...
<?php endif; ?>
    ...
    <div class="mx-[26px] mt-[48.4px]">
        <h1 class="text-lg font-medium text-[#343a40]">
            <?php echo e(count($reservations) ? 'My reservations' : 'No reservations found'); ?>

        </h1>
        <div class="mt-[28px] flex flex-col gap-[20px]">
            <?php if(count($reservations)): ?>
                <?php $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="/restaurant/<?php echo e($reservation->restaurant->id); ?>">
                        <div class="flex flex-col p-[10px] bg-white rounded-lg gap-[6px] shadow-2xl">
                            <div class="rounded-t-lg h-[103.3px] w-full">
                                ...
                                ?>
                                <img src="<?php echo e($finalImageUrl); ?>" class="w-full h-full object-cover rounded-t-[8px]" />
                            </div>
                    </a>
                    <div class="text-[#343a40]">
                        <p class="text-sm font-medium mb-[7.8px]"><?php echo e($reservation->restaurant->title); ?></p>
                        <div class="flex flex-col gap-[7px]">
                            <div class="flex text-[#343a40] gap-[12.5px]">
                                ...
                                <p class="text-[8px]"><?php echo e($reservation->restaurant->address); ?></p>
                            </div>
                            <div class="flex text-[#343a40] gap-[12.5px]">
                                ...
                                <p class="text-[8px]"><?php echo e(date('l, jS M Y', strtotime($reservation->date))); ?></p>
                            </div>
                            <div class="flex text-[#343a40] gap-[12.5px]">
                                <svg width="13" height="13" viewBox="0 0 13 13" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                                ...
                                <p class="text-[8px]"><?php echo e(date('H:i', strtotime($reservation->time))); ?></p>
                            </div>
                            <div class="flex text-[#343a40] gap-[12.5px]">
                                <svg width="13" height="13" viewBox="0 0 13 13" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                                ...
                                <p class="text-[8px]"><?php echo e($reservation->number_of_people); ?></p>
                            </div>
                        </div>
        ...
        <div class="rounded-lg bg-white px-[82px] pt-[56px] pb-[76px] w-[470px] h-[274px]"
            ...
            <div class="flex gap-[34px] justify-center">
                ...
                <?php if(isset($reservation)): ?>
                    <form action="<?php echo e(route('user.reservations.destroy', $reservation->id)); ?>" class="cursor-pointer"
                        method="post">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\reservation\resources\views/userreservations.blade.php ENDPATH**/ ?>