<?php $__env->startSection('content'); ?>
    ...
    <div id="editReservationModal" style="display: none;"
        ...
        <div class="rounded-lg bg-white w-[728px] flex flex-col items-center"
            ...
            <form action="<?php echo e(route('restaurant.reservation.update')); ?>" method="post">
                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function fetchAndDisplayReservations(selectedDate) {
            restuarantId = <?php echo e($restaurant->id); ?>;
            const url =
...
<?php echo $__env->make('layouts.restaurant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\reservation\resources\views/restaurant/calendar.blade.php ENDPATH**/ ?>