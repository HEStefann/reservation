...
<body class="min-h-screen flex flex-col">
    ...
    <div class="mx-[26px] flex flex-grow flex-col">
        ...
        <div class="flex mt-[19px]">
            ...
            <p class="text-base font-medium text-left text-[#343a40] underline underline-offset-2 decoration-[#FC7F09]">
                Pick your date
            </p>
        </div>
        <div class="mt-[6px]">
            <div class="flex flex-col gap-[18px] px-6 py-[18px] rounded-lg"
                ...
                <div class="flex gap-[22px]">
                    ...
                    <button type="button" id="tomorrowButton"
                        class="text-[#005fa4] w-[50%] font-medium h-7 rounded-[10px] border border-[#005fa4]">
                        Tomorrow
                    </button>
                </div>
                ...
                <div class="calendar flex flex-col gap-[18px]">
                </div>
            </div>
        </div>
        ...
        <div class="mt-[14px] grid grid-cols-4 gap-[15px]">
            @for ($i = 12; $i < 24; $i++)
                <button
                    class="text-base rounded-[10px] bg-[#fff5ec] text-[#343a40] px-[14px] py-[10px]">{{ $i }}:00</button>
                <button
                    class="text-base rounded-[10px] bg-[#fff5ec] text-[#343a40] px-[14px] py-[10px]">{{ $i }}:30</button>
            @endfor
        </div>
        ...
        <div class="flex items-center gap-[8px]">
            <button class="w-7 h-7 rounded-lg bg-[#fff5ec] border-[0.3px] border-[#fc7f09]">-</button>
            <p class="text-[22px] text-[#343a40]">2</p>
            <button class="w-7 h-7 rounded-lg bg-[#fff5ec] border-[0.3px] border-[#fc7f09]">+</button>
        </div>
        <div class="flex mt-[28px] mb-[16px]">
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex flex-col gap-[9px]">
            <button type="button"
                class="h-10 px-[22px] rounded-lg bg-[#fff5ec] text-sm text-left text-[#6b686b]">Full
                name</button>
            <button type="button"
                class="h-10 px-[22px] rounded-lg bg-[#fff5ec] text-sm text-left text-[#6b686b]">Phone
                number</button>
            <button type="button"
                class="h-10 px-[22px] rounded-lg bg-[#fff5ec] text-sm text-left text-[#6b686b]">Email</button>
        ...
        <button class="rounded-[10px] mt-[60px] mb-[20px] py-[8px] text-xl font-semibold text-white"
    ...
    <script>
        ...
        prevButton.addEventListener('click', function() {
            // Get the current month and year from the monthYear element
            ...
            // Subtract one month from the previous month date
            prevMonthDate.setMonth(prevMonthDate.getMonth() - 1);

            // Update the calendar with the previous month's date
        ...
        nextButton.addEventListener('click', function() {
            ...
            // Add one month to the next month date
            nextMonthDate.setMonth(nextMonthDate.getMonth() + 1);

            // Update the calendar with the next month's date
        ...
        tomorrowButton.addEventListener('click', function() {
            ...
            // Update the calendar with tomorrow's date
    ...
    `;
            ...
            for (let i = 1; i <= daysInMonth; i++) {
                calendarHTML += `<div class="text-[#4a5660] text-base">${i}</div>`;
            }
