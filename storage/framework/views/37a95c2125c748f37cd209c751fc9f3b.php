        ...
        <div class="rounded-lg bg-white w-[589px]" style="box-shadow: 0px 20px 50px 0 rgba(0,0,0,0.1);">
            ...
            <div class="ml-[30px] mr-[100px] mb-[32px] mt-[36px] flex flex-col gap-[12px]">
                ...
                <div class="flex justify-between">
                    ...
                    <textarea value="<?php echo e(old('note')); ?>" name="note" id="note" cols="30" rows="10"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\reservation\resources\views/components/restaurant-navbar.blade.php ENDPATH**/ ?>