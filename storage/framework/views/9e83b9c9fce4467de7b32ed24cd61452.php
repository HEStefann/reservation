<div class="min-h-screen min-w-[217px] flex flex-col">
    ...
    <div class="flex flex-col gap-[16px] mt-[11px] pl-[16px] w-full h-full"
        ...
        <a href="<?php echo e(route('restaurant.calendar')); ?>" class="flex gap-[34px]">
        ...
        <a href="<?php echo e(route('restaurant.reservations')); ?>" class="flex gap-[34px]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="<?php echo e(route('restaurant.floor-plan')); ?>" class="flex gap-[34px]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="<?php echo e(route('restaurant.settings')); ?>" class="flex gap-[34px]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="flex-grow-0 flex-shrink-0 w-6 h-6 relative" preserveAspectRatio="xMidYMid meet">
                <path
