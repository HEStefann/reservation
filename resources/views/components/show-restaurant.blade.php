<div class="snap-center w-[148px] h-[196px] relative" style="filter: drop-shadow(0px 20px 50px rgba(187, 186, 186, 0.1));">
    ...
    <div class="w-32 h-[152px]">
        ...
        <div class="w-32 h-[42.78px]">
            <p class="w-32 h-[18.91px] absolute left-2.5 top-[119.22px] text-sm font-medium text-left text-[#343a40]">
                Chicken Biryani
            </p>
            <div class="w-[85px] h-5">
                <svg width="9" height="11" viewBox="0 0 9 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="absolute left-2.5 top-[142px]" preserveAspectRatio="xMidYMid meet">
                ...
                <p class="w-[71px] h-5 absolute left-6 top-[142px] text-[8px] text-left text-[#6b686b]">
                    <span class="w-[71px] h-5 text-[8px] text-left text-[#6b686b]">Ambrosia Hotel
                        &#x26;</span><br /><span
                        class="w-[71px] h-5 text-[8px] text-left text-[#6b686b]">Restaurant</span>
                </p>
            </div>
        </div>
    </div>
    <p class="absolute left-6 top-[165px] text-[6px] text-left text-[#6b686b]">American</p>
    ...
    <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        class="absolute left-[110px] top-[141px]" preserveAspectRatio="none">
        <path
