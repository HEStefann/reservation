        ...
        @foreach ($restaurant->reviews as $review)
            <div class="mb-[14px]">
                <div id="ReviewsTab" class="w-[338px] h-[76px] relative"
                    ...
                    <div class="w-[338px] h-[76px] absolute left-[-0.55px] top-[-0.55px] rounded-[10px] bg-white">
                    </div>
                    <div
                        class="flex justify-between items-center w-[65.12px] h-5 absolute left-[255.31px] top-[9px] bg-white">
            ...
            <div class="flex justify-between">
                ...
                <div class="flex items-center gap-[13px]">
                    ...
                    <svg width="14" height="7" viewBox="0 0 14 7" fill="none"
                        ...
                        <path opacity="0.8" d="M1.50024 1L7.3166 6L13.133 1" stroke="black" stroke-width="1.2"
            ...
            <div class="flex justify-between items-center">
                <div>
                    <svg width="7" height="12" viewBox="0 0 7 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="opacity-80" preserveAspectRatio="none">
                        <path opacity="0.8" d="M6.25763 1L0.999999 6L6.25763 11" stroke="black" stroke-width="1.2"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </div>
                ...
                <div>
                    <svg width="8" height="12" viewBox="0 0 8 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="opacity-80" preserveAspectRatio="none">
                        <path opacity="0.8" d="M1.38812 11L6.64575 6L1.38812 1" stroke="black" stroke-width="1.2"
                            stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </div>
            </div>
